...
# ─────────────────────────────────────────────────────────────────────────────
# 🔼 Upgrade 01:
#   ▪️ By     : Sharath 13-06-2025
#   ▪️ Change : Added functionality to convert user-input AWS service name to lowercase
#
...
case $aws_service in
    ...
    *)
    ...
    echo "✅ Valid services: ec2, rds, s3, cloudfront, vpc, iam, route53, cloudwatch, cloudformation, lambda, sns, sqs, dynamodb, ebs"
    exit 1
    ;;
